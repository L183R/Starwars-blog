...
export const Cardnav = ({nombres, ids, tipo}) => {
  const {store, actions} = useContext(Context)
  return (
    <div className="card m-1 col-3" style={{width: "15rem", height: "auto"}}>
  <img src={"https://starwars-visualguide.com/assets/img/starships/"+ids+".jpg"} className="card-img-top" alt="..."></img>
  <div className="card-body">
  <h5 className={`${store.texto} card-title`}>{nombres}</h5>
    <Link to={"/naves/"+ids} className={`btn ${store.estilo1}`}>A ver...</Link>
